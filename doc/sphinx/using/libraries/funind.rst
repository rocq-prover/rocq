...
.. flag:: Function_raw_tcc
   ...
   When Function is using a well founded relation, this option (when
   set) prevents the post-processing of the tcc generated for
   termination. (The post-processing is basically conjunction
   splitting + auto.)
   Off by default.
