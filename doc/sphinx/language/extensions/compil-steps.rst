...
.. note::
   ...
   synterp phase for every comman in the file before running any
...
In particular, no typecheking is involved during parsing or
...
.. example:: Reserved notation
   ...
   parser so that :n:`_ + _` can later be parsed.
