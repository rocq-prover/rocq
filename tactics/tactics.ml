...
let general_elim_clause with_evars flags where arg elimc =
  match where with
  | None -> general_elim_clause0 with_evars flags arg (ElimConstant elimc)
  | Some id -> general_elim_clause_in0 with_evars flags id arg elimc
