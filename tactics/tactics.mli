...
(** [mutual_fix f idx fs n] refines the goal using a mutual fixpoint.
    - [f] and [idx] are the name and recursive argument index for the [n]-th fixpoint
      (i.e. the fixpoint which is inserted at position [n] in the mutual block).
...
(** [mutual_cofix f fs n] refines the goal using a mutual cofixpoint.
    - [f] is the name of the [n]-th cofixpoint (i.e. the cofixpoint which is inserted
      at position [n] in the mutual block). The type of [f] is simply the conclusion of the goal.
