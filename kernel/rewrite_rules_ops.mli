...
module QState : sig
  type t
  val merge_qconstraints : Sorts.QCumulConstraints.t -> t -> t * Sorts.QCumulConstraints.t
  val to_qconstraints : t -> Sorts.QCumulConstraints.t
...
val push_uconstraint :
  QState.t -> (Quality.t * Universe.t * Conversion.conv_pb * Universe.t) -> Constraints.t -> Constraints.t
...
val nf_evar_map : Evar.t list -> QState.t -> (imitation_cmp * constr) Evar.Map.t ->
