...
type ('constr, 'types, 'r) ptype_error =
  ...
  | BadInvert
  | BadVariance of { lev : (Level.t,Sorts.QVar.t) Util.union; expected : Variance.t; actual : Variance.t }
...
val error_bad_variance : env -> lev:(Level.t,Sorts.QVar.t) Util.union -> expected:Variance.t -> actual:Variance.t -> 'a
