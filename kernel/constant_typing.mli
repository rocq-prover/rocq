...
val infer_parameter :
  sec_univs:UVars.UContext.t list option -> env -> parameter_entry ->
    ('a, unit) pconstant_body

val infer_definition :
  sec_univs:UVars.UContext.t list option -> env -> definition_entry ->
    HConstr.t option * ('a, unit) pconstant_body

val infer_opaque :
  sec_univs:UVars.UContext.t list option -> env -> 'a opaque_entry ->
