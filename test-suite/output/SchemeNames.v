...
(** * Schemes for inductive SProp *)
  ...
  (** ** Try Induction into all Sorts *)
       ...
       Scheme Induction for fooSProp Sort SProp. (* fooSProp_sind *)
  ...
  (** ** Try Minimality into all Sorts *)
       ...
       Scheme Minimality for fooSProp Sort SProp. (* fooSProp_sind_nodep *)
  ...
  About fooSProp_sind_nodep.

  (** ** Try Elimination into all Sorts *)

       Scheme Elimination for fooSProp Sort SProp. (* fooSProp_scase *)
...
(** * Schemes for inductive Prop *)
  ...
  (** ** Try Induction into all Sorts *)
       ...
       Scheme Induction for fooProp Sort SProp. (* fooProp_sind_dep *)
  ...
  About fooProp_sind_dep.
  About fooProp_ind_dep.

  (** ** Try Minimality into all Sorts *)

       Scheme Minimality for fooProp Sort SProp. (* fooProp_sind *)
  ...
  (** ** Try Elimination into all Sorts *)
       ...
       Scheme Elimination for fooProp Sort SProp. (* fooProp_scase_dep *)
  ...
  About fooProp_scase_dep.
  About fooProp_case_dep.

  (** ** Try Case into all Sorts *)

       Scheme Case for fooProp Sort SProp. (* fooProp_scase *)
...
(** * Schemes for inductive Set *)
  ...
  Scheme Induction for fooSet Sort SProp. (* fooSet_sind *)
  ...
  Scheme Minimality for fooSet Sort SProp. (* fooSet_sind_nodep *)
  ...
  Scheme Elimination for fooSet Sort SProp. (* fooSet_scase *)
  ...
  Scheme Case for fooSet Sort SProp. (* fooSet_scase_nodep *)
...
(** * Schemes for inductive Type *)
  ...
  Scheme Induction for fooType Sort SProp. (* fooType_sind *)
  ...
  Scheme Minimality for fooType Sort SProp. (* fooType_sind_nodep *)
  ...
  Scheme Elimination for fooType Sort SProp. (* fooType_scase *)
  ...
  Scheme Case for fooType Sort SProp. (* fooType_scase_nodep *)
