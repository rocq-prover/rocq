...
Fail Definition check_unblock@{u} : forall (T : Type@{u}), Blocked@{Type;u} T -> T := fun T x => __unblock@{Type;u} T x.
...
Definition unblock_prop_type (b : Blocked@{Prop;_} (tt = tt)) : Blocked Type :=
  __block Type (type_of (__unblock _ b)).
