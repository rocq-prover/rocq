...
Goal (if if bool_decide (decide_rel _ type_eq_dec (Tarch Tvoid Tvoid) (Tarch Tvoid Tvoid)) then true else false then True else False).
  ...
  time "cbn  " cbn.        (* Tactic call cbn   ran for 0.707 secs (0.706u,0.s) (su *)
Abort.
...
Module Prim.
  ...
  Eval cbn     in @add 8    10 (build_fn 10). (* 0s *)
  Eval cbn     in @add 10   10 (build_fn 10). (* 0s    *)
  Eval cbn     in @add 20   20 (build_fn 20). (* 0s    *)
End Prim.
...
Module NonPrim.
  ...
  Time Eval cbn     in @add 2000 10 (build_fn 10). (* 0.1s   *)
  Time Eval cbn     in @add 2000 20 (build_fn 20). (* 0.2s   *)
  Time Eval cbn     in @add 4000 20 (build_fn 20). (* 0.4s   *)
End NonPrim.
