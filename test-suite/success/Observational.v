...
Instance obseq_Has_Leibniz_elim@{α β;l l' +} : Has_Leibniz@{α SProp β;l Set l'} (@obseq) :=
 { leibniz := fun A x P px y e => cast (P x) (P y) (ap@{_ _ _ _;l _ _ _ _} P e) px}.

Instance obseq_Has_Leibniz_r_elim@{α β;l l' +} : Has_Leibniz_r@{α SProp β;l Set l'} (@obseq) :=
 { leibniz_r := fun A x P px y e => cast (P x) (P y) (ap@{_ _ _ _;l _ _ _ _} P (sym e)) px}.

Definition obseq_apd@{sa sb; la lb lb' +}
    {A : Type@{sa;la}} {a} (P : forall b : A, a ~ b -> Type@{sb ; lb})
    (b : A) (e : a ~ b) : @obseq _ (P a (refl A a)) (P b e) :=
    J _ a (fun b e => @obseq _ (P a (refl _ _)) (P b e)) (refl _ _) b e.

Instance eq_Has_J_elim@{α β;l l' +} : Has_J@{α SProp β;l l l'} (@obseq) _ :=
  { J := fun A a P t b e => cast (P a (refl _ _)) (P b e)
    (obseq_apd@{α β ;l l' _ _} P b e) t }.
