...
val print_full_context : Summary.Interp.t ->
  Global.indirect_accessor -> env -> Evd.evar_map -> Pp.t
val print_full_context_typ : Summary.Interp.t ->
  env -> Evd.evar_map -> Pp.t

val print_full_pure_context : Summary.Interp.t ->
  Global.indirect_accessor -> env -> Evd.evar_map -> Pp.t

val print_sec_context : Summary.Interp.t ->
  Global.indirect_accessor -> env -> Evd.evar_map -> qualid -> Pp.t
val print_sec_context_typ : Summary.Interp.t ->
  env -> Evd.evar_map -> qualid -> Pp.t
val print_judgment : env -> Evd.evar_map -> EConstr.unsafe_judgment -> Pp.t
val print_safe_judgment : Safe_typing.judgment -> Pp.t

val print_name : Summary.Interp.t ->
  Global.indirect_accessor -> env -> Evd.evar_map
...
val print_abbreviation : Summary.Interp.t ->
  Global.indirect_accessor -> env -> Evd.evar_map -> KerName.t -> Pp.t

val print_about : Summary.Interp.t ->
