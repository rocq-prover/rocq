...
$coq_opam_package (dependency install failed in $RUNNER)"
        ...
        for iteration in $(seq $num_of_iterations); do
            ...
            _RES=0
            timeout "$timeout" opam install -y -v -b -j 32 $coq_opam_package \
