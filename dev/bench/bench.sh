...
: "${new_opam_override_urls:=rocq-equations.dev git+https://github.com/jrosain/Rocq-Equations#elimination-constraint-graph coq-lsp.dev git+https://github.com/jrosain/rocq-lsp#elimination-constraints-graph}"
