...
: "${new_coq_opam_archive_git_uri:=https://github.com/gares/opam.git}"
: "${old_coq_opam_archive_git_uri:=https://github.com/rocq-prover/opam.git}"
: "${new_coq_opam_archive_git_branch:=ssrpat-FO-ignore-imparg}"
: "${old_coq_opam_archive_git_branch:=master}"
: "${new_coq_version:=dev}"
: "${old_coq_version:=dev}"
: "${num_of_iterations:=1}"
: "${timeout:=3h}"
: "${coq_opam_packages:=rocq-elpi rocq-mathcomp-ssreflect rocq-mathcomp-fingroup rocq-mathcomp-algebra rocq-mathcomp-solvable rocq-mathcomp-field rocq-mathcomp-character coq-mathcomp-odd-order}"
: "${coq_native:=}"
