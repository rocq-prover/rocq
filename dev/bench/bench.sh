...
: "${new_opam_override_urls:=rocq-elpi.dev git+https://github.com/skyskimmer/coq-elpi#bignat rocq-equations.dev git+https://github.com/skyskimmer/coq-equations#bignat rocq-metarocq-template.dev https://github.com/skyskimmer/metarocq#bignat}"
