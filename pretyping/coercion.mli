...
val inh_conv_coerce_to : Summary.Interp.t -> ?loc:Loc.t -> program_mode:bool -> resolve_tc:bool ->
...
val inh_conv_coerce_rigid_to : Summary.Interp.t -> ?loc:Loc.t -> program_mode:bool -> resolve_tc:bool ->
  ?use_coercions:bool -> env -> evar_map -> ?flags:Evarconv.unify_flags ->
  unsafe_judgment -> types -> evar_map * unsafe_judgment * coercion_trace option
...
(** [inh_app_fun resolve_tc env isevars j] coerces [j] to a function; i.e. it
    ...
    resort before failing) *)
val inh_app_fun : Summary.Interp.t -> program_mode:bool -> resolve_tc:bool -> ?use_coercions:bool ->
