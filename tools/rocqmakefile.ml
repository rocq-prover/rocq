...
let normal_mode ~coqlib project prog args =
  ...
  if project.rocq_package = None && project.warn_missing_rocq_package then begin
    eprintf "Warning: Omitting --rocq-package is deprecated.\n";
    eprintf "Warning: Use --rocq-package <package> to enable the Findlib-backed Rocq package installation scheme.\n";
