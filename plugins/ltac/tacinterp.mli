...
sig
  ...
  val closure : interp_sign -> glob_tactic_expr -> Tacarg.tacvalue
  val of_closure : interp_sign -> glob_tactic_expr -> t
  val cast : 'a typed_abstract_argument_type -> Geninterp.Val.t -> 'a
  val apply : Tacarg.tacvalue -> t list -> unit Proofview.tactic
  val apply_val : Tacarg.tacvalue -> t list -> t Ftactic.t
end
