...
val pr_quality_with_global_universes : ?binders:universe_binders -> Quality.QVar.t -> Pp.t
val qualid_of_quality : universe_binders -> Quality.QVar.t -> Libnames.qualid option
