...
let finalize ?collapse_sort_variables ?abort_on_undefined_evars sigma ?(partial=false) f =
  let sigma = minimize_universes ~partial ?collapse_sort_variables sigma in
