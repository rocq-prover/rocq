...
*)
val pr_open_subgoals       : ?quiet:bool -> ?oldp:Proof.t option -> Proof.t -> Pp.t
val pr_nth_open_subgoal    : ?oldp:Proof.t -> proof:Proof.t -> int -> Pp.t
...
val pr_goal_by_id : ?oldp:Proof.t -> proof:Proof.t -> Id.t -> Pp.t
